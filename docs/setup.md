...
as of now. The open-source version is currently in Alpha. As we proceed over the
...
Open the `EarlGrey.xcodeproj` file and ensure that each of the four targets
build.

<img src="images/targets.png">

Add the `EarlGrey.xcodeproj` file to your project's Xcode. This is as simple as
a drag and drop inside your Xcode Project. Ensure that the EarlGrey targets are
now present in your list of targets. In case any of the newly added projects are
greyed out, please close any open Xcode Projects and re-open your test project.
...
Please create a Bridging Header for your Swift Test Target and add the following
imports:
...
Add any further imports from Objective-C as would be needed in your test. You
can also just add
[EarlGreySwiftBridgingHeader.h](../TestLib/Swift/EarlGreySwiftBridgingHeader.h) to
your Test Component.
